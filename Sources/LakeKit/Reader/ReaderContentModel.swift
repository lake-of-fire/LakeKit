...
public extension URL {
    func matchesReaderURL(_ url: URL?) -> Bool {
        ...
        if url.absoluteString.starts(with: "about:load/manabi?reader-url="), let range = url.absoluteString.range(of: "?reader-url=", options: []), let rawURL = String(url.absoluteString[range.upperBound...]).removingPercentEncoding, let contentURL = URL(string: rawURL) {
